        ...
        <div class="overflow-x-auto bg-white rounded-md shadow  dark:bg-dark-800">
                <table class="w-full whitespace-nowrap">
                    ...
                    @forelse ($contacts as $contact)
                        <tr
                            class="hover:bg-dark-100 dark:hover:bg-dark-600 focus-within:bg-dark-100 dark:border-dark-700">
                            <td class="border-t dark:border-dark-700">
                            ...
                            <td class="w-px border-t dark:border-dark-700">
                                <a tabindex="-1" href="{{ route('contacts.edit', $contact) }}"
                                    class="flex items-center px-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                        class="block w-6 h-6 text-dark-400 dark:text-dark-400">
                                        <polygon
                    ...
                    @empty
                        <tr class="text-center dark:border-dark-700">
                            <td class="border-t dark:border-dark-700" colspan="4">
