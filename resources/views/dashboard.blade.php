<x-app-layout>
    <div class="container grid p-4 mx-auto lg:p-12 md:p-6">
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            <!-- Card -->
            <x-stat-card color="yellow" title="Total clients" desc="6389">
                <x-slot name="svg">
            ...
            <!-- Card -->
            <x-stat-card color="blue" title="New sales" desc="376">
                <x-slot name="svg">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path
            ...
            <!-- Card -->
            <x-stat-card color="purple" title="Account balance" desc="$ 46,760.89">
                <x-slot name="svg">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- Card -->
            <x-stat-card color="green" title="Pending contacts" desc="35">
                <x-slot name="svg">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
