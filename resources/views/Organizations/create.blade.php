<x-app-layout>
    <div scroll-region="" class="md:flex-1 px-4 py-8 md:p-12 md:overflow-y-auto">
        <div>
            <h1 class="mb-8 font-bold text-3xl"><a href="https://demo.inertiajs.com/organizations"
                    class="text-indigo-400 hover:text-indigo-600">Organizations</a> <span
                    class="text-indigo-400 font-medium">/</span> Create
            </h1>
            <div class="bg-white rounded-md shadow overflow-hidden max-w-full">
                <form>
                    ...
                    <div class="px-8 py-4 bg-gray-50 border-t border-gray-100 flex justify-end items-center"><button
                            class="flex items-center bg-indigo-200 px-3 py-2 rounded-md text-indigo-500 hover:bg-indigo-100" type="submit">
                            Create Organization
                        </button></div>
                </form>
            </div>
