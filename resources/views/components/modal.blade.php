<div class="absolute inset-0 flex items-center justify-center bg-gray-900 bg-opacity-25" x-show="open">
    <div
        ...
        <h3 class="text-lg font-medium leading-6 text-gray-900" id="headlessui-dialog-title-6">Delete Organization
        </h3>
        <div class="mt-2">
            <p class="text-sm text-gray-500">Your payment has been successfully submitted. We’ve sent your an email
                with
                all
        ...
        <div class="mt-4">
            <button type="button"
                class="inline-flex justify-center px-4 py-2 text-sm font-medium text-red-100 bg-red-500 border border-transparent rounded-md hover:bg-red-400
