...
<div class="flex-shrink-0 flex items-center px-6 py-4 bg-gg-900 h-16">
            <a href="{{ route('dashboard') }}" class="flex items-center justify-between">
                <x-application-logo class="w-12 h-12 text-gray-600 dark:text-gray-100 mr-1" strok="0.75" linecap="round" />
                <span class="text-md font-semibold text-gray-500 ml-1 uppercase">HK Dashboard</span>
            </a>
        </div>
